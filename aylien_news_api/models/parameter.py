...
class Parameter(object):
    ...
    def __init__(self, author_id=None, author_name=None, body=None, categories_confident=None, categories_id=None, categories_level=None, categories_taxonomy=None, clusters=None, links_permalink=None, entities_body_links_dbpedia=None, entities_body_text=None, entities_body_type=None, entities_title_links_dbpedia=None, entities_title_text=None, entities_title_type=None, id=None, language=None, media_images_content_length_max=None, media_images_content_length_min=None, media_images_count_max=None, media_images_count_min=None, media_images_format=None, media_images_height_max=None, media_images_height_min=None, media_images_width_max=None, media_images_width_min=None, media_videos_count_max=None, media_videos_count_min=None, sentiment_body_polarity=None, sentiment_title_polarity=None, social_shares_count_facebook_max=None, social_shares_count_facebook_min=None, social_shares_count_reddit_max=None, social_shares_count_reddit_min=None, source_domain=None, source_id=None, source_links_in_count_max=None, source_links_in_count_min=None, source_locations_city=None, source_locations_country=None, source_locations_state=None, source_rankings_alexa_country=None, source_rankings_alexa_rank_max=None, source_rankings_alexa_rank_min=None, source_scopes_city=None, source_scopes_country=None, source_scopes_level=None, source_scopes_state=None, story_url=None, story_language=None, text=None, title=None, translations_en_body=None, translations_en_text=None, translations_en_title=None, entity=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._entities_body_links_dbpedia = None
        self._entities_body_text = None
        self._entities_body_type = None
        self._entities_title_links_dbpedia = None
        self._entities_title_text = None
        self._entities_title_type = None
        self._id = None
        self._language = None
        ...
        if entities_body_links_dbpedia is not None:
            self.entities_body_links_dbpedia = entities_body_links_dbpedia
        if entities_body_text is not None:
            self.entities_body_text = entities_body_text
        if entities_body_type is not None:
            self.entities_body_type = entities_body_type
        if entities_title_links_dbpedia is not None:
            self.entities_title_links_dbpedia = entities_title_links_dbpedia
        if entities_title_text is not None:
            self.entities_title_text = entities_title_text
        if entities_title_type is not None:
            self.entities_title_type = entities_title_type
        if id is not None:
            self.id = id
    ...
    @property
    def entities_body_links_dbpedia(self):
        """Gets the entities_body_links_dbpedia of this Parameter.  # noqa: E501


        :return: The entities_body_links_dbpedia of this Parameter.  # noqa: E501
        :rtype: Query
        """
        return self._entities_body_links_dbpedia

    @entities_body_links_dbpedia.setter
    def entities_body_links_dbpedia(self, entities_body_links_dbpedia):
        """Sets the entities_body_links_dbpedia of this Parameter.


        :param entities_body_links_dbpedia: The entities_body_links_dbpedia of this Parameter.  # noqa: E501
        :type entities_body_links_dbpedia: Query
        """

        self._entities_body_links_dbpedia = entities_body_links_dbpedia

    @property
    def entities_body_text(self):
        """Gets the entities_body_text of this Parameter.  # noqa: E501


        :return: The entities_body_text of this Parameter.  # noqa: E501
        :rtype: Query
        """
        return self._entities_body_text

    @entities_body_text.setter
    def entities_body_text(self, entities_body_text):
        """Sets the entities_body_text of this Parameter.


        :param entities_body_text: The entities_body_text of this Parameter.  # noqa: E501
        :type entities_body_text: Query
        """

        self._entities_body_text = entities_body_text

    @property
    def entities_body_type(self):
        """Gets the entities_body_type of this Parameter.  # noqa: E501


        :return: The entities_body_type of this Parameter.  # noqa: E501
        :rtype: Query
        """
        return self._entities_body_type

    @entities_body_type.setter
    def entities_body_type(self, entities_body_type):
        """Sets the entities_body_type of this Parameter.


        :param entities_body_type: The entities_body_type of this Parameter.  # noqa: E501
        :type entities_body_type: Query
        """

        self._entities_body_type = entities_body_type

    @property
    def entities_title_links_dbpedia(self):
        """Gets the entities_title_links_dbpedia of this Parameter.  # noqa: E501


        :return: The entities_title_links_dbpedia of this Parameter.  # noqa: E501
        :rtype: Query
        """
        return self._entities_title_links_dbpedia

    @entities_title_links_dbpedia.setter
    def entities_title_links_dbpedia(self, entities_title_links_dbpedia):
        """Sets the entities_title_links_dbpedia of this Parameter.


        :param entities_title_links_dbpedia: The entities_title_links_dbpedia of this Parameter.  # noqa: E501
        :type entities_title_links_dbpedia: Query
        """

        self._entities_title_links_dbpedia = entities_title_links_dbpedia

    @property
    def entities_title_text(self):
        """Gets the entities_title_text of this Parameter.  # noqa: E501


        :return: The entities_title_text of this Parameter.  # noqa: E501
        :rtype: Query
        """
        return self._entities_title_text

    @entities_title_text.setter
    def entities_title_text(self, entities_title_text):
        """Sets the entities_title_text of this Parameter.


        :param entities_title_text: The entities_title_text of this Parameter.  # noqa: E501
        :type entities_title_text: Query
        """

        self._entities_title_text = entities_title_text

    @property
    def entities_title_type(self):
        """Gets the entities_title_type of this Parameter.  # noqa: E501


        :return: The entities_title_type of this Parameter.  # noqa: E501
        :rtype: Query
        """
        return self._entities_title_type

    @entities_title_type.setter
    def entities_title_type(self, entities_title_type):
        """Sets the entities_title_type of this Parameter.


        :param entities_title_type: The entities_title_type of this Parameter.  # noqa: E501
        :type entities_title_type: Query
        """

        self._entities_title_type = entities_title_type
