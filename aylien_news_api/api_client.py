...
class ApiClient(object):
    ...
    def __init__(self, host=None, header_name=None, header_value=None, cookie=None):
        ...
        self.user_agent = "aylien-news-api/%s/python" % __version__
    ...
    def sanitize_for_serialization(self, obj):
        ...
        If obj is api model, return the properties dict.
        ...
        if isinstance(obj, type(None)):
            ...
            if isinstance(obj, dict):
                ...
                obj_dict = {obj.attribute_map[attr]: getattr(obj, attr)
                            for attr, _ in iteritems(obj.api_types)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not instance.api_types:
            return data

        for attr, attr_type in iteritems(instance.api_types):
            if data is not None \
